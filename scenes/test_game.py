import pygame
from pygame import *
from core.hitbox import HitboxSprite
...
my_hitbox = HitboxSprite("assets/sprites/hitbox/dart.png")
listy = my_hitbox.hitbox

for i in range (len(listy)):
    print(listy[i])

current_coords = (10, 18)
print(my_hitbox.hit(current_coords))
